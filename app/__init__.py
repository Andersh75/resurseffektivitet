...
app = Flask(__name__)
app.config['SQLALCHEMY_DATABASE_URI'] = 'mysql://root:1111111111@localhost/f17'
db = SQLAlchemy(app)
...
def csvimporter():
    ...
    for i in teachers_list:
        already = db.session.query(exists().where(or_(Teachers.kthid==i[0], Teachers.email==i[2]))).scalar()
